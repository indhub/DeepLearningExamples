...
learning_rate=${2:-"4.68e-5"}
precision=${3:-"fp16"}
num_gpus=${4:-8}
warmup_proportion=${5:-"0.2843"}
train_steps=${6:-1000000}
save_checkpoint_steps=${7:-1000000}
...
DATA_DIR_PHASE1="/data/bert/pt/phase1"
BERT_CONFIG=bert_config.json
#CODEDIR=${24:-"/workspace/bert"}
CODEDIR="/shared/DeepLearningExamples/PyTorch/LanguageModeling/BERT"
init_checkpoint=${25:-"None"}
RESULTS_DIR=/scratch/bertresults
